                                ...
                                <div class="tab-pane fade show active" id="tab-general">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="color" name="website_color" class="form-control form-control-color"
                                                value="{{ $settings['website_color'] ?? '#007bff' }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Website Text Color</label>
                                            <input type="color" name="website_text_color"
                                                class="form-control form-control-color"
                                                value="{{ $settings['website_text_color'] ?? '#1b1b18' }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3 text-center">
                                            ...
                                            @if(isset($settings['header_logo']))
                                                <img src="{{ asset($settings['header_logo']) }}" class="img-thumbnail mb-2"
                                                    style="height: 100px;">
                                            @endif
                                        ...
                                        <div class="col-md-4 mb-3 text-center">
                                            ...
                                            @if(isset($settings['footer_logo']))
                                                <img src="{{ asset($settings['footer_logo']) }}" class="img-thumbnail mb-2"
                                                    style="height: 100px;">
                                            @endif
                                        ...
                                        <div class="col-md-4 mb-3 text-center">
                                            ...
                                            @if(isset($settings['favicon']))
                                                <img src="{{ asset($settings['favicon']) }}" class="img-thumbnail mb-2"
                                                    style="height: 40px;">
                                            @endif
                                        ...
                                        <div class="col-md-4 mb-3 text-center">
                                            ...
                                            @if(isset($settings['loading_gif']))
                                                <img src="{{ asset($settings['loading_gif']) }}" class="img-thumbnail mb-2"
                                                    style="height: 100px;">
                                            @endif
                                        ...
                                        <div class="col-md-4 mb-3 text-center">
                                            ...
                                            @if(isset($settings['app_logo']))
                                                <img src="{{ asset($settings['app_logo']) }}" class="img-thumbnail mb-2"
                                                    style="height: 100px;">
                                            @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-check form-switch border p-3 rounded">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="show_posts" value="on"
                                                    {{ ($settings['show_posts'] ?? 'on') == 'on' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-check form-switch border p-3 rounded">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="show_partners"
                                                    value="on" {{ ($settings['show_partners'] ?? 'on') == 'on' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-check form-switch border p-3 rounded">
                                                ...
                                                <input class="form-check-input" type="checkbox"
                                                    name="show_friend_suggestions" value="on" {{ ($settings['show_friend_suggestions'] ?? 'on') == 'on' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-check form-switch border p-3 rounded">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="show_recent_activity"
                                                    value="on" {{ ($settings['show_recent_activity'] ?? 'on') == 'on' ? 'checked' : '' }}>
