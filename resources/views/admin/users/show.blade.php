        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    ...
                    <a href="{{ route('admin.users.edit', $user->username) }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <span class="avatar avatar-xl rounded-circle" style="background-image: url({{ asset($user->avatar ?? 'frontend/assets/images/user/1.jpg') }})"></span>
                        </div>
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <span class="badge bg-green-lt">Joined: {{ $user->created_at->format('M Y') }}</span>
                            <span class="badge {{ $user->status === 'active' ? 'bg-success' : 'bg-danger' }} text-white">{{ ucfirst($user->status ?? 'Active') }}</span>
                        </div>
                    </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2"><strong>Designation:</strong> {{ $user->designation->name ?? 'None' }}</div>
                                ...
                                <div class="row align-items-center mb-2">
                                    <div class="col">
                                        <div class="text-secondary">
                                            On post: <a href="{{ route('posts.show', $comment->post_id) }}" target="_blank">#{{ $comment->post_id }}</a>
                                        </div>
                    ...
                    <div class="col-6">
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-yellow text-white avatar"><i class="ti ti-message"></i></span>
                                    </div>
                                    <div class="col">
