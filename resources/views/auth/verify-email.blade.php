    ...
    <div class="col-md-6">
        <div class="sign-in-from text-center">
            ...
            <form class="mt-5" method="POST" action="{{ route('verification.send') }}">
                ...
                <button type="submit" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100">Verify Email
                    Address</button>
            </form>

            <form class="mt-5"method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100">Log Out</button>
            </form>
        </div>
    </div>
@endsection
