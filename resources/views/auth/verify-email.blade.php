    ...
    <div class="col-md-6">
        <div class="sign-in-from text-center">
            <a href="../index.html" class="d-inline-flex align-items-center justify-content-center gap-2">
                ...
                <h2 class="logo-title" data-setting="app_name">{{env("APP_NAME")}}</h2>
            </a>
            <p class="mt-3 font-size-16">Welcome to {{env("APP_NAME")}}</p>
            <p class="mt-3 font-size-16">We have sent a verification code to your email. Please check your inbox and verify your account.</p>
            ...
            <form class="mt-5"method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100">Back</button>
            </form>
        </div>
    </div>
@endsection
