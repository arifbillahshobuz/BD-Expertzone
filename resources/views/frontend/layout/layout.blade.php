...
<head>
    ...
    <link rel="stylesheet" href="assets/css/socialv097b.css?v=5.2.0">
    <link rel="stylesheet"
    ...
    <!-- zuck -->
    <!-- lib styles -->
    <link rel="stylesheet" href="assets/vendor/zuck.js-master/dist/zuck.min.css">
    <!-- lib skins -->
    <link rel="stylesheet" href="assets/vendor/zuck.js-master/dist/skins/snapssenger.min.css">
    <link rel="stylesheet" href="assets/vendor/zuck.js-master/dist/skins/facesnap.css">

    <!-- Custom Css -->
    <link rel="stylesheet" href="assets/css/custom097b.css?v=5.2.0" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="assets/css/customizer097b.css?v=5.2.0" /></head>
                ...
                <li class="nav-item">
                    <a class="nav-link "
                       href="dashboard/pages-comingsoon.html">
                        ...
                        <span class="item-name">Pages Coming soon</span>
                    </a>
                </li>
                <li>
                    <hr class="hr-horizontal">
            ...
            <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar p-lg-0">
                <div class="container-fluid navbar-inner">
                    <div class="d-flex align-items-center pb-2 pb-lg-0 d-xl-none">
                        <a href="index.html" class="d-flex align-items-center iq-header-logo navbar-brand d-block d-xl-none">
                            <svg width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="search-modal-body">
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/page-img/19.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/page-img/18.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                                    <div>
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/page-img/20.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                                    <div>
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/user/06.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/user/08.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/user/15.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center search-hover py-2 px-3">
                                            <div class="flex-shrink-0">
                                                <img src="../assets/images/user/13.html" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                            </div>
                                            <div class="d-flex ms-3 w-100 justify-content-between">
                                                <div class="d-flex flex-column">
                                        ...
                                        <div class="item-header-scroll">
                                            <a href="javascript:void(0);">
                                                <div class="thread d-flex align-items-center justify-content-between rounded-0">
                                                    <div>
                                                        <img class="avatar-40 rounded-pill align-top" src="assets/images/user/01.jpg" alt="" loading="lazy">
                                                        <div class="ms-3 d-inline-block">
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="thread d-flex align-items-center justify-content-between rounded-0">
                                                    <div>
                                                        <img class="avatar-40 rounded-pill align-top" src="assets/images/user/02.jpg" alt="" loading="lazy">
                                                        <div class="ms-3 d-inline-block">
                                                            <h6>John Travolta</h6>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="thread d-flex align-items-center justify-content-between rounded-0">
                                                    <div>
                                                        <img class="avatar-40 rounded-pill align-top" src="assets/images/user/03.jpg" alt="" loading="lazy">
                                                        <div class="ms-3 d-inline-block">
                                                            <h6>Maya Didas</h6>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="thread d-flex align-items-center justify-content-between rounded-0">
                                                    <div>
                                                        <img class="avatar-40 rounded-pill align-top" src="assets/images/user/07.jpg" alt="" loading="lazy">
                                                        <div class="ms-3 d-inline-block">
                                                            <h6>Paige Turner</h6>
                                        ...
                                        <div class="item-header-scroll">
                                            <a href="javascript:void(0);">
                                                <div class="d-flex gap-3 mb-4">
                                                    <img class="avatar-32 rounded-pill" src="assets/images/user/01.jpg" alt="">
                                                    <div>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="d-flex gap-3 mb-4">
                                                    <img class="avatar-32 rounded-pill" src="assets/images/user/02.jpg" alt="" loading="lazy">
                                                    <div>
                                             ...
                                             more_horiz
                                                ...
                                                <div class="user-post mt-4">
                                                    <a data-fslightbox="gallery" href="assets/images/page-img/fun.jpg" class="rounded">
                                                        <img src="assets/images/page-img/fun.jpg" alt="post-image"
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="d-inline-flex align-items-center gap-1">
                                                            ...
                                                            <span class="text-capitalize font-size-14 fw-medium" type="button"
                                                                  data-bs-toggle="modal" data-bs-target="#likemodal">and 208 others liked this</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="dropdown-menu py-2 shadow">
                                                                        <a class="ms-2 me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Like"><img
                                                                                src="assets/images/icon/01.png" class="img-fluid" alt="like"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Love"><img
                                                                                src="assets/images/icon/02.png" class="img-fluid" alt="love"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Happy"><img
                                                                                src="assets/images/icon/03.png" class="img-fluid" alt="happy"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="HaHa"><img
                                                                                src="assets/images/icon/04.png" class="img-fluid" alt="haha"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Think"><img
                                                                                src="assets/images/icon/05.png" class="img-fluid" alt="think"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Sad"><img
                                                                                src="assets/images/icon/06.png" class="img-fluid" alt="sad"
                                                                                loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                           data-bs-placement="top" title="Lovely"><img
                                                                                src="assets/images/icon/07.png" class="img-fluid" alt="lovely"
                                                                                loading="lazy"></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="card card-block card-stretch card-height">
                                          ...
                                          <span class="dropdown-toggle material-symbols-outlined" data-bs-toggle="dropdown"
                                             ...
                                             more_horiz
                                                ...
                                                <div class="mt-4">
                                                    <p class="m-0">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi.
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-6">
                                                            <a data-fslightbox="gallery" href="assets/images/page-img/mountain.jpg" class="rounded">
                                                                <img src="assets/images/page-img/mountain.jpg" alt="post-image" class="img-fluid rounded w-100"
                                                                     loading="lazy">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-6 mt-md-0 mt-3">
                                                            <div class="post-overlay-box h-100 rounded">
                                                                <img src="assets/images/page-img/pizza.jpg" alt="post-image" class="img-fluid rounded w-100 h-100 object-cover"
                                                                     loading="lazy">
                                    ...
                                    <div class="col-sm-12 social-post">
                                       ...
                                       <span class="dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                          ...
                                          <span class="fw-medium">140 Likes</span>
                                                                    ...
                                                                    <div class="dropdown-menu py-2 shadow">
                                                                        <a class="ms-2 me-2" href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                           title="Like"><img src="assets/images/icon/01.png" class="img-fluid" alt="like"
                                                                                             loading="lazy"></a>
                                                                        <a class="me-2" href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                           title="Love"><img src="assets/images/icon/02.png" class="img-fluid" alt="love"
                                                                                             loading="lazy"></a>
                                                        ...
                                                        <div class="d-flex align-items-center gap-3 flex-shrink-0">
                                                            <div class="total-comment-block" type="button" data-bs-toggle="collapse" data-bs-target="#commentcollapes3"
                                                                 aria-expanded="false" aria-controls="commentcollapes">
                                    <span class="material-symbols-outlined align-text-top font-size-20">
                                       comment
                                    </span>
                                                                <span class="fw-medium">20 Comment</span>
                                                            ...
                                                            <div class="share-block d-flex align-items-center feather-icon">
                                                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#share-btn" aria-controls="share-btn"
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        ...
                                                                        <div class="comment-list-user-data">
                                                                            <div class="d-inline-flex align-items-center gap-1 flex-wrap">
                                                                                <h6 class="m-0">Bob Frapples</h6>
                                                                                <span class="d-inline-block text-primary">
                                                   <svg class="align-text-bottom" xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                                        viewBox="0 0 17 17" fill="none">
                                                      <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M12.2483 0.216553H4.75081C2.13805 0.216553 0.5 2.0665 0.5 4.68444V11.7487C0.5 14.3666 2.13027 16.2166 4.75081 16.2166H12.2475C14.8689 16.2166 16.5 14.3666 16.5 11.7487V4.68444C16.5 2.0665 14.8689 0.216553 12.2483 0.216553Z"
                                                            fill="currentColor" />
                                                      <path d="M5.5 8.21627L7.50056 10.216L11.5 6.21655" stroke="white" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                   </svg>
                                                </span>
                                                                                <spna class="fw-medium small text-capitalize">3 min ago</spna>
                                                   ...
                                                   <span class="fw-medium small" data-bs-toggle="collapse"
                                                      ...
                                                      Reply
                                                        ...
                                                        <div class="add-comment-form-block">
                                                            <div class="d-flex align-items-center gap-3">
                                                                <div class="flex-shrink-0">
                                                                    <img src="assets/images/user/1.jpg" alt="userimg" class="avatar-48 rounded-circle img-fluid"
                                                                         loading="lazy">
                                                                </div>
                                                                <div class="add-comment-form">
                                                                    <form>
                                          ...
                                          <svg class="align-text-bottom" width="17" height="17" viewBox="0 0 17 17" fill="none"
                                             ...
                                             <path d="M5.09741 7.99978L7.09797 9.9995L11.0974 6.00006" stroke="white"
                                                   stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                    ...
                                                                    <span class="mb-0 d-inline-block text-capitalize fw-medium">Added New Video in his Timeline</span>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="fixed-suggestion mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <ul class="list-inline m-0 p-0">
                                            <li class="mb-3">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="assets/images/user/06.jpg" alt="story-img"
                                                         class="avatar-60 avatar-borderd object-cover avatar-rounded img-fluid d-inline-block">
                                                    <div>
                                            ...
                                            <li class="mb-3">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="assets/images/user/07.jpg" alt="story-img"
                                                         class="avatar-60 avatar-borderd object-cover avatar-rounded img-fluid d-inline-block">
                                                    <div>
                                                        <div class="d-flex align-items-center justify-content-between gap-2">
                                                            <div>
                                            ...
                                            <li class="d-flex justify-content-between flex-wrap gap-2">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="assets/images/user/08.jpg" alt="story-img"
                                                         class="avatar-60 avatar-borderd object-cover avatar-rounded img-fluid d-inline-block">
                                                    <div>
                                                        <div class="d-flex align-items-center justify-content-between gap-2">
                                                            <div>
                                    ...
                                    <div class="card-body pt-0">
                                        <ul class="list-inline m-0 p-0">
                                            <li class="d-flex mb-3 pb-3 border-bottom">
                                                <img src="assets/images/user/09.jpg" alt="story-img"
                                                     class="avatar-32 avatar-rounded object-cover img-fluid">
                                                <div class="stories-data ms-3">
                                                    <h6 class="font-size-14">Esther Howard <span class="fw-normal text-body">reacted comment
                              in to your</span> <span class="fw-normal">post.</span></h6>
                                                    <small class="text-capitalize">19 min ago</small>
                                                </div>
                                            </li>
                                            <li class="d-flex mb-3 pb-3 border-bottom">
                                                <img src="assets/images/user/10.jpg" alt="story-img"
                                                     class="avatar-32 avatar-rounded object-cover img-fluid">
                                                <div class="stories-data ms-3">
                              ...
                              you.</span></h6>
                                            ...
                                            <li class="d-flex mb-3 pb-3 border-bottom">
                                                <img src="assets/images/user/13.jpg" alt="story-img"
                                                     class="avatar-32 avatar-rounded object-cover img-fluid">
                                                <div class="stories-data ms-3">
                                            ...
                                            <li class="d-flex">
                                                <img src="assets/images/user/14.jpg" alt="story-img"
                                                     class="avatar-32 avatar-rounded object-cover img-fluid">
                                                <div class="stories-data ms-3">
                                                    <h6 class="font-size-14">Dima Davydov <span class="text-body fw-normal">replied to your
                              comment</span></h6>
                                                    <small class="text-capitalize">1 month ago</small>
                                                </div>
                                            </li>
        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item"><a href="https://templates.iqonic.design/socialv-dist/dashboard/privacy-policy.html">Privacy Policy</a></li>
                    <li class="list-inline-item ms-3 ms-md-5"><a href="https://templates.iqonic.design/socialv-dist/dashboard/terms-of-service.html">Terms of Use</a></li>
                </ul>
            </div>
