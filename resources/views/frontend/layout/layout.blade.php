            ...
            <div class="content-inner " id="page_layout">
                ...
                <div class="modal fade likemodal" id="likemodal" tabindex="-1" aria-labelledby="likemodalLabel"
                  ...
                  <span class="nav-link" id="reaction-tab-2" data-bs-toggle="tab" data-bs-target="#reaction-tab-like"
                     ...
                     <img src="{{asset('frontend/')}}/assets/images/icon/01.png" class="img-fluid reaction-img"
                          alt="like"
                          loading="lazy">
                  ...
                  <span class="nav-link" id="reaction-tab-3" data-bs-toggle="tab" data-bs-target="#reaction-tab-love"
                     ...
                     <img src="{{asset('frontend/')}}/assets/images/icon/02.png" class="img-fluid reaction-img"
                          alt="love"
                          loading="lazy">
                  ...
                  <span class="nav-link" id="reaction-tab-4" data-bs-toggle="tab" data-bs-target="#reaction-tab-happy"
                     ...
                     <img src="{{asset('frontend/')}}/assets/images/icon/03.png" class="img-fluid reaction-img"
                          alt="happy"
                          loading="lazy">
                     <span class="align-middle">3</span>
                  </span>
                  ...
                  <span class="nav-link" id="reaction-tab-5" data-bs-toggle="tab" data-bs-target="#reaction-tab-haha"
                     ...
                     <img src="{{asset('frontend/')}}/assets/images/icon/04.png" class="img-fluid reaction-img"
                          alt="haha"
                          loading="lazy">
