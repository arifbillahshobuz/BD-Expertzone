    ...
    <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar p-lg-0 mt-0">
        <div class="container-fluid navbar-inner  ">
            <div class="d-flex align-items-center pb-2 pb-lg-0 d-xl-none">
                <a href="{{ route('dashboard') }}" class="d-flex align-items-center iq-header-logo navbar-brand d-block d-xl-none">
                    ...
                    <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive d-none d-xl-block" tabindex="-1" id="offcanvasBottomNav">
                        <div class="offcanvas-body">
                            <ul class="iq-nav-menu list-unstyled">
                                <li class="nav-item">
                                    <a class="nav-link menu-arrow justify-content-start active" href="{{route('dashboard')}}">
