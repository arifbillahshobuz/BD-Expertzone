<aside class="sidebar sidebar-default sidebar-base navs-rounded-all " id="first-tour" data-toggle="main-sidebar"
    ...
    <div class="sidebar-header d-flex align-items-center justify-content-start position-relative">
        <a href="{{ route('home') }}" class="d-flex align-items-center gap-2 iq-header-logo">
            ...
            <h3 class="logo-title" data-setting="app_name">{{env('APP_NAME') ?? 'BD Expert Zone '}} </h3>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @auth()
                <li class="nav-item">
                    <a class="nav-link" href="{{route('user.profile', ['username' => $user->username])}}" role="button">
                        <i class="icon material-symbols-outlined">
                            person
                        </i>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#friend-list" role="button"
