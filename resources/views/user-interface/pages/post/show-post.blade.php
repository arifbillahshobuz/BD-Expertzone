                        ...
                        <div class="mt-4 pt-4 border-top collapse show" id="commentcollapes{{ $post->id }}">
                                        ...
                                        <div class="comment-list-block">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="ms-auto">
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="dropdown-toggle material-symbols-outlined comment-action-btn"
                                                            data-bs-toggle="dropdown" aria-haspopup="true"
                                                            aria-expanded="false" aria-label="Comment actions"
                                                        ...
                                                        <div class="dropdown-menu m-0 p-0">
                                                            <a class="dropdown-item p-3 delete-comment-btn d-flex align-items-start gap-3"
                                                                ...
                                                                data-type="comment">
                                                                <span
                                                                    class="material-symbols-outlined fs-3 text-danger flex-shrink-0">delete</span>
                                                                <span>
                                                                    <span class="fw-bold d-block">Delete Comment</span>
                                                                    <span class="text-muted small">Remove this comment
                                                                        permanently.</span>
                                                                </span>
                                                            </a>
                                                            <a class="dropdown-item p-3 hide-comment-btn d-flex align-items-start gap-3"
                                                                href="#" data-id="{{ $comment->id }}"
                                                                data-type="comment">
                                                                <span
                                                                ...
                                                                <span>
                                                                    ...
                                                                    <span class="text-muted small">See fewer comments
                                                                        like this.</span>
                                                                </span>
                                                            </a>
                                                        </div>
                                                                    ...
                                                                    <div class="comment-list-block">
                                                                        <div class="d-flex align-items-center gap-3">
                                                                            <div
                                                                                ...
                                                                                <img src="{{ $reply->user->avatar ?? '/frontend/assets/images/user/1.jpg' }}"
                                                                                    alt="userimg"
                                                                                    class="avatar-48 rounded-circle img-fluid"
                                                                                    loading="lazy">
                                                                            </div>
                                                                            <div class="comment-list-user-data">
                                                                                <div
                                                                                    ...
                                                                                    <h6 class="m-0">
                                                                                        {{ $reply->user->name }}</h6>
                                                                                    <span
                                                                                        class="d-inline-block text-primary"></span>
                                                                                    <span
                                                                                        class="fw-medium small text-capitalize">{{ $reply->created_at->diffForHumans() ?? '' }}</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="ms-auto">
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu m-0 p-0">
                                                                                        <a class="dropdown-item p-3 delete-comment-btn d-flex align-items-start gap-3"
                                                                                            ...
                                                                                            <span>
                                                                                                <span
                                                                                                    class="fw-bold d-block">Delete
                                                                                                    Reply</span>
                                                                                                <span
                                                                                                    class="text-muted small">Remove
                                                                                                    this reply
                                                                                                    permanently.</span>
                                                                                            </span>
                                                                                        </a>
                                                                                        <a class="dropdown-item p-3 hide-comment-btn d-flex align-items-start gap-3"
                                                                                            ...
                                                                                            <span>
                                                                                                <span
                                                                                                    class="fw-bold d-block">Hide
                                                                                                    Reply</span>
                                                                                                <span
                                                                                                    class="text-muted small">See
                                                                                                    fewer replies like
                                                                                                    this.</span>
                                                                                            </span>
                                                                                        </a>
                                                                                ...
                                                                                <ul
                                                                                    ...
                                                                                    <li>
                                                                                        <span class="fw-medium small"
                                                                                            ...
                                                                                            data-bs-target="#subcomment-collapse-{{ $reply->id }}"
                                                                                            role="button">Reply</span>
                                                                                    </li>
                                                                                </ul>
                                                                                <div class="add-comment-form-block collapse mt-3"
                                                                                    id="subcomment-collapse-{{ $reply->id }}">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="add-comment-form">
                                                                                            <form class="reply-form"
                                                                                                ...
                                                                                                action="{{ route('comments.reply', $reply) }}"
                                                                                                method="POST">
                                                                                                @csrf
                                                                                                <input type="text"
                                                                                                    name="content"
                                                                                            ...
                                                                                            <li
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="comment-list-user-img flex-shrink-0">
                                                                                                            <img src="{{ $subreply->user->avatar ?? '/frontend/assets/images/user/1.jpg' }}"
                                                                                                                alt="userimg"
                                                                                                                class="avatar-48 rounded-circle img-fluid"
                                                                                                                loading="lazy">
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="comment-list-user-data">
                                                                                                            <div
                                                                                                                class="d-inline-flex align-items-center gap-1 flex-wrap">
                                                                                                                <h6
                                                                                                                    class="m-0">
                                                                                                                ...
                                                                                                                <span
                                                                                                                    class="d-inline-block text-primary"></span>
                                                                                                                <span
                                                                                                                    class="fw-medium small text-capitalize">{{ $subreply->created_at->diffForHumans() ?? '' }}</span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="ms-auto">
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="comment-list-user-comment">
                                                                                                        <div
                                                                                                            class="comment-list-comment">
                                                                                                            {{ $subreply->content }}
                                                                                                        </div>
                                                                                                        <div
                                                                                                            ...
                                                                                                            <ul
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    <span
                                                                                                                        ...
                                                                                                                        data-bs-toggle="collapse"
                                                                                                                        data-bs-target="#subcomment-collapse-{{ $subreply->id }}"
                                                                                                                        role="button">Reply</span>
                                                                                                                </li>
                                                                                                            </ul>
                                                                                                            <div class="add-comment-form-block collapse mt-3"
                                                                                                                id="subcomment-collapse-{{ $subreply->id }}">
                                                                                                                <div
                                                                                                                    class="d-flex align-items-center gap-3">
                                                                                                                    <div
                                                                                                                        class="flex-shrink-0">
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <form
                                                                                                                            class="reply-form"
                                                                                                                            data-comment-id="{{ $subreply->id }}"
                                                                                                                            action="{{ route('comments.reply', $subreply) }}"
                                                                                                                            method="POST">
                                                                                                                            @csrf
                                                                                                                            <input
                                                                                                                                type="text"
                                                                                                            ...
                                                                                                            <!-- Recursive call for deeper nested replies can be added here if needed -->
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </li>
                            ...
                            <div class="add-comment-form-block">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="add-comment-form">
                                        <form id="main-comment-form-{{ $post->id }}"
